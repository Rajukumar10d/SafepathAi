        ...
        <div className={styles.container}>
            <div className={styles.header}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
                    <div>
                        <h1 className={`${styles.title} animate-fade-in`}>Live Safety Map</h1>
                        <p className={`${styles.subtitle} animate-fade-in delay-100`}>
                            Enter source and destination to view the safest route.
                        </p>
                    </div>
                    <button
                        onClick={() => setShowEmergency(!showEmergency)}
                        className="animate-fade-in delay-100"
                        style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', backgroundColor: '#ef4444', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer', fontWeight: 600, fontSize: '0.95rem' }}
                    >
                        <AlertTriangle size={20} />
                        {showEmergency ? 'Close Emergency Info' : 'Emergency Actions'}
                    </button>
                </div>
