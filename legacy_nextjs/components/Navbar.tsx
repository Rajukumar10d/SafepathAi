        ...
        <nav className={`${styles.navbar} ${isScrolled ? styles.scrolled : ''}`}>
            ...
            <div className={`${styles.navLinks} ${isMenuOpen ? styles.menuOpen : ''}`}>
                ...
                <div className={styles.mobileActions}>
                    <Link href="/login" className={`${styles.loginBtn} btn`}>Log In</Link>
                    <Link href="/login?signup=true" className={`${styles.signupBtn} btn`}>Sign Up</Link>
                </div>
            </div>

            <div className={styles.desktopActions}>
                <Link href="/login" className={styles.navLink} style={{ marginRight: '1rem' }}>
                    Log In
                </Link>
