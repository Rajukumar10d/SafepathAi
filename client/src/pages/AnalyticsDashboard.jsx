...
const TOP_RISK_AREAS = [
    { name: 'Sanganer Outer Ring Rd', risk: 'High', incidents: 12 },
    { name: 'Old City Back Alleys, Udaipur', risk: 'High', incidents: 9 },
    { name: 'Basni Industrial Area, Jodhpur', risk: 'Medium', incidents: 5 },
    { name: 'Kushalgarh Remote Sectors', risk: 'Medium', incidents: 6 },
    { name: 'Vishwa Karma Industrial Area', risk: 'Medium', incidents: 4 },
];
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                <h1 className={`${styles.title} animate-up`}><span className="shimmer-text">Safety Analytics</span></h1>
                <p className={`${styles.subtitle} animate-up`} style={{ animationDelay: '100ms' }}>
                    Deep insights into local safety trends and predictive intelligence.
                </p>
            </div>
